...
lf_bg = '#838B8B' # bg color for the left_frame
cf_bg = '#8B8878' # bg color for the center_frame
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM", font=headlabelfont, bg='grey').pack(side=TOP, fill=X)
...
# Help me, i can't express my feelings to her
